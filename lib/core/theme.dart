  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        displaySmall: GoogleFonts.sora(color: AppColors.textPrimary, fontWeight: FontWeight.bold),
        headlineLarge: GoogleFonts.sora(color: AppColors.textPrimary, fontWeight: FontWeight.bold),
        headlineMedium: GoogleFonts.sora(color: AppColors.textPrimary, fontWeight: FontWeight.bold),
        headlineSmall: GoogleFonts.sora(color: AppColors.textPrimary, fontWeight: FontWeight.bold),
        ...
        labelLarge: GoogleFonts.dmSans(color: AppColors.primary, fontWeight: FontWeight.bold),
      ),
